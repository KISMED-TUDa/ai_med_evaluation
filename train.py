...
Example training code for KIS*MED model. And Playground.
KIS*MED models computes the standard deviation of BBIs of ECG Signal for each recording. Finds optimal threshold to split classes 'A' and 'N'.
